<section id="single_course" class="white section">
            <div class="container">
                <div class="row">
                ...
                <div id="owl-featured" class="owl-custom owl-carousel owl-theme owl-loaded">
                    <!-- end col -->
                    ...
                    <!-- end col -->
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1155px, 0px, 0px); transition: 0s; width: 3465px;"><div class="owl-item cloned" style="width: 273.75px; margin-right: 15px;"><div class="owl-featured">
                    ...
                    </div></div><div class="owl-item active" style="width: 273.75px; margin-right: 15px;"><div class="owl-featured">
                        <div class="shop-item-list entry">
                            <div class="">
                                <img src="upload/course_01.png" alt="">
                                <div class="magnifier">
                    ...
                    </div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style=""><i class="fa fa-angle-left"></i></div><div class="owl-next" style=""><i class="fa fa-angle-right"></i></div></div><div class="owl-dots" style="display: none;"></div></div></div><!-- end owl-featured -->
            </div><!-- end container -->
        </section>
